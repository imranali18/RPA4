...
class Point2d(object):
    ...
    def scale(self, s):
        ...
        scale value. This changes the object rather than creating a new object
        """
        self.x *= s
        self.y *= s
    ...
    def __add__(self, o):
        """
        Add the two Point2d object coordinate-wise, returning a new Point2d
        object.
        """
    ...
    def __sub__(self, o):
        """
        Subtract the two Point2d object coordinate-wise, returning a new Point2d
        object.
        """
        return Point2d(self.x - o.x, self.y - o.y)
    ...
    def __mul__(self, s):
        """
        Multiply the coordinates of a Point2d object by a scale factor, returning
    ...
    def __eq__(self,o):
        """
        Return True iff the coordinate values of the two Point2d objects are
        the same.
        """
        return self.x == o.x and self.y == o.y
